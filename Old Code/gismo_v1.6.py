...
# interaction, and IR distance sensor for reverse obstacle avoidance. 
...
# different melodies, provides visual feedback with the RGB LED, shakes when 
# touched, displays a smiling face on the OLED normally and a sad face when an 
# object or edge is detected, and uses the IR distance sensor to prevent 
...
buzzer_pin = 18
touch_sensor = 9
ir_distance_pin = 14  # KY-032 on GPIO 14
...
GPIO.setup(ir_distance_pin, GPIO.IN)  # Set IR distance sensor pin as input
