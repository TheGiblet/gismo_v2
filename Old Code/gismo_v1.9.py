...
# control for debugging, and tilt sensor for tilt detection.
...
# obstacles, allows button-triggered debugging actions (running sensor
# test code files), and responds to tilt events.
...
GPIO.setup(tilt_pin, GPIO.IN)  # Set tilt sensor pin as input
