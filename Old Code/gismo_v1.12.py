...
# code files), takes a picture when an object is detected, responds to
# commands from an IR remote, and reacts to sound using the sound sensor.
...
sound_sensor_pin = 21  # TS-YM-115 on GPIO 21
...
GPIO.setup(sound_sensor_pin, GPIO.IN)  # Set sound sensor pin as input
            ...
            if event.type == ecodes.EV_KEY:
                ...
                if key_event.keystate == key_event.key_down:
                    ...
                    if key_event.keycode == "KEY_UP":
                        ...
                        set_motor_speed(motor1_in1, motor1_in2, -50)
                        set_motor_speed(motor2_in1, motor2_in2, 50)
                    elif key_event.keycode == "KEY_OK":  # Example: Stop on KEY_OK
                        print("Stopping")
                        set_motor_speed(motor1_in1, motor1_in2, 0)
                        set_motor_speed(motor2_in1, motor2_in2, 0)
